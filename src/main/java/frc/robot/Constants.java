...
public final class Constants {
  ...
  public static final class SwerveDriveConstants {
    ...
    public static final double kDrivePrecisionMultiplier = 0.4; // fractional
    
    public static final double kTurnMaxVelocity = 5; // rad/s
  ...
  public static final class PathPlannerConstants {
    ...
    public static final double kPP_ThetaP = new PrefDouble("PP_kThetaP", 5).get();
  ...
  public static final class VisionConstants {
    ...
    public static final String kLimelightFrontIP = "10.6.87.200:5800";
  ...
  public static final class IndexerConstants {
    ...
    public static final PrefDouble kIndexerVelocityRPS = new PrefDouble("Indexer Velocity", 30); // 90
    public static final PrefDouble kTrapVelocityRPS = new PrefDouble("Trap Velocity", 27); // 81
